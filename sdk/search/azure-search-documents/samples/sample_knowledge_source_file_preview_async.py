...
DESCRIPTION:
    ...
    Async version of sample_knowledge_source_file_preview.py.
...
async def create_file_knowledge_source_and_attach():
    # [START create_file_knowledge_source_and_attach_async]
    ...
    # [END create_file_knowledge_source_and_attach_async]


async def get_and_retrieve_source():
    # [START get_file_knowledge_source_and_retrieve_async]
    from azure.core.credentials import AzureKeyCredential
    ...
    # [END get_file_knowledge_source_and_retrieve_async]
...
async def main():
    try:
        await create_file_knowledge_source_and_attach()
