...
DESCRIPTION:
    ...
    Async version of sample_knowledge_source_workiq_preview.py.
...
async def create_workiq_knowledge_source_and_attach():
    # [START create_workiq_knowledge_source_and_attach_async]
    ...
    # [END create_workiq_knowledge_source_and_attach_async]


async def get_and_retrieve_source():
    # [START get_workiq_knowledge_source_and_retrieve_async]
    from azure.core.credentials import AzureKeyCredential
    ...
    # [END get_workiq_knowledge_source_and_retrieve_async]
...
async def main():
    try:
        await create_workiq_knowledge_source_and_attach()
